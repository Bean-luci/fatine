...
public class _01_General {
	...
	public static void main(String[] args) {
		 ...
		 * Un bloc d'instriction est contenu entre"{}"
		 * Les variables déclarées dans un bloc ne sont accéssible que dans ce bloc
		 */
		System.out.println("cette instruction se termine formément par un \";\"");{
